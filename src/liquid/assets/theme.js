...
slate.Variants = (function() {
  ...
  Variants.prototype = _.assignIn({}, Variants.prototype, {
    ...
    _updateMasterSelect: function(variant) {
      const select = document.querySelector(`${this.originalSelectorId}`);
      if(variant && variant.id) {
        select.value = variant.id;
      }
      let event = new CustomEvent("change");
      event.shop = { variant, product: this.product };
...
theme.customerTemplates = (function() {
  function initEventListeners() {
    ...
    $('a#RecoverPassword').on('click', function(evt) {
      evt.preventDefault();
...
theme.Product = (function() {
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _initVariants: function() {
      ...
      this.$container.trigger("variantChange");
      this.$container.on(
    ...
    switchProductImage: function(imageId) {
      ...
      $imagesToHide.addClass('gallery-mobile-hide');
      $imageToShow.removeClass('gallery-mobile-hide');
    },
  ...
  if ($(stickHeaderClass).length !== 0){
    ...
    $(window).scroll(function() {
      ...
      if (window.pageYOffset > sticky) {
        ...
        const height = $(stickHeaderClass).css("height");
        $page.style.paddingTop = height;
      } else {
  ...
  var initPhotoSwipeFromDOM = function(gallerySelector) {
    ...
    var parseThumbnailElements = function(el) {
        ...
        for(var i = 0; i < numNodes; i++) {
            ...
            if(figureEl.classList.contains("figure-video")) {
              continue;
            }
    ...
    var onThumbnailsClick = function(e) {
        ...
        var clickedListItem = closest(eTarget, function(el) {
            return (el.tagName && el.tagName.toUpperCase() === 'FIGURE' && !el.classList.contains("figure-video"));
        });
...
theme.anchorScroll = (function(){
  $(document).on('click', 'a[href^="#"]', function (event) {
    event.preventDefault();
    if(event.target.getAttribute("href") === "#") { return false; }
